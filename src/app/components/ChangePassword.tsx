    ...
    <div>
      {step === 1 ? (
        <form onSubmit={handleConfirmOldPassword} className="">
          ...
          <button
            type="submit"
            className={`flex items-center justify-center space-x-2 w-full h-10 rounded-md shadow-md text-white ${
        ...
        <form onSubmit={handleUpdatePassword} className="">
          ...
          <div className="flex justify-between mt-6">
            ...
            <button
              ...
              className="flex items-center justify-center space-x-2 w-1/2 h-10 rounded-md shadow-md text-white bg-gray-500
            ...
            <button
              ...
              hover:bg-orange-900 duration-100 ml-2"
            >
